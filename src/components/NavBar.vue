...
<template>
    <nav class="sticky top-0 w-[300px] flex flex-col pl-5 pr-5 h-[100vh] z-[1]" id="principalNav">
        ...
        <router-link class="relative flex items-center gap-2.5 mb-5 mt-auto rounded-xl text-[17px] font-medium py-3 px-4 text-white no-underline transition-all duration-200 ease-in-out hover:bg-[#406071] hover:cursor-pointer active:bg-[#406071] active:font-bold" id="profile" to="/profile">
