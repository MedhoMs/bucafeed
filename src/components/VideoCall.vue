  ...
  <div class="flex flex-col h-full bg-[#0a151b] overflow-hidden relative">
    ...
    <div class="absolute bottom-10 left-1/2 -translate-x-1/2 z-40 w-max">
        <div class="px-6 py-3 bg-[#1a2e3a]/80 backdrop-blur-2xl border border-white/10 rounded-3xl flex items-center gap-4 shadow-2xl ring-1 ring-white/5">
            ...
            <button 
                @click="toggleMic"
                class="cursor-pointer" :class="[isMicOn ? 'bg-white/10 text-white hover:bg-white/20' : 'bg-red-500 text-white shadow-lg shadow-red-500/20', 'w-10 h-10 rounded-2xl flex items-center justify-center transition-all active:scale-90 border border-white/10']"
            >
            ...
            <button 
                @click="toggleCamera"
                class="cursor-pointer" :class="[isCameraOn ? 'bg-white/10 text-white hover:bg-white/20' : 'bg-red-500 text-white shadow-lg shadow-red-500/20', 'w-10 h-10 rounded-2xl flex items-center justify-center transition-all active:scale-90 border border-white/10']"
            >
            ...
            <button 
                @click="$emit('close')"
                class="bg-[#ff3b30] text-white hover:bg-red-600 px-6 h-10 rounded-2xl flex items-center justify-center transition-all active:scale-95 shadow-lg shadow-red-500/20 border border-white/10 gap-2 cursor-pointer"
            >
