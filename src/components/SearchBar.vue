...
<template>
    <div class="flex my-3 w-full">
        <div class="flex flex-row items-center bg-[#2a4a5a] rounded-[20px] p-[15px] min-w-full hover:bg-[#334d5e] focus-within:bg-[#334d5e] focus-within:outline-solid focus-within:outline-1 focus-within:outline-[#1da1f2]">
            ...
            <input 
                ...
                class="ml-3 w-full outline-hidden text-base border-none bg-transparent flex-1 text-[#e7e9ea] placeholder-[#8b98a5]"
            />
        </div>
    </div>
</template>
