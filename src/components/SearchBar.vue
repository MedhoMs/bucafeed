...
<template>
    <div class="flex justify-end my-3">
        <div class="group flex bg-[#2a4a5a] rounded-[20px] px-4 py-3 lg:w-375 w-75 items-center hover:bg-[#334d5e] focus-within:bg-[#334d5e] focus-within:outline focus-within:outline-[#1da1f2]">
            ...
            <input type="text" :placeholder="t.nav.search || 'Buscar'" class="ml-3 w-full flex-1 outline-none border-none bg-transparent text-base text-[#e7e9ea] placeholder-[#8b98a5]" >
        </div>
    </div>
</template>
