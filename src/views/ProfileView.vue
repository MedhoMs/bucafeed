            ...
            <section class="bg-[#15202b80] text-white flex-1">
                ...
                <div class="px-5 pb-2.5 -mt-2">
                    <div class="flex items-center gap-1">
                        <h2 class="nombre text-2xl font-bold m-0 text-[#e7e9ea]">{{ user ? user.name : 'Usuario' }}</h2>
                    ...
                    <p class="nombre-usuario text-[#8b98a5] text-base my-0.5 mx-0">{{ user ? user.email : 'Usuario' }}</p>
