...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $eventImageHandler = function ($path) {
            ...
            // Source paths (checking multiple possible roots)
            $srcSource = base_path('../src/assets/' . $filename);
            $appSource = base_path('../backend/storage/app/public/' . $path);
            $publicSource = public_path('assets/' . $filename);
            
            $sourcePath = file_exists($srcSource) ? $srcSource : (file_exists($appSource) ? $appSource : $publicSource);
