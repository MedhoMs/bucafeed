...
Route::post('/admin/roles/create', [RoleController::class, 'store'])->name('role.store');

Route::get('/admin/roles/edit/{id}', [RoleController::class, 'edit'])->name('role.edit');
Route::post('/admin/roles/edit/{id}', [RoleController::class, 'update'])->name('role.update');
...
Route::post('/admin/roles/destroy/{id}', [RoleController::class, 'destroyPost'])->name('role.destroy.post');
