    ...
    <x-slot:tbody>
        ...
        @php
            $columns = [
                ...
                ['type' => 'text', 'value' => $question->title, 'class' => 'text-white font-medium max-w-[200px] truncate', 'title' => $question->title],
                ...
                ['type' => 'text', 'value' => $question->tags->pluck('name')->implode(', ') ?: 'Sin etiquetas', 'class' => 'text-white/60 text-xs italic max-w-[150px] truncate'],
