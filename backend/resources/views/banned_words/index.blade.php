<div class="container mx-auto pt-4 relative">
    <div class="flex flex-col gap-3">
        @forelse($bannedWords as $word)
            <div class="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-xl group transition-all duration-200 hover:bg-white/10">
                ...
                <div class="flex items-center gap-2">
                    <a href="#" data-url="/admin/banned-words/edit/{{ $word->id }}" data-load="modal" data-title="Editar Palabra Vetada"
                    ...
                    <a href="#" data-url="/admin/banned-words/{{ $word->id }}" data-load="modal" data-title="Eliminar Palabra Vetada"
        ...
        @empty
            <p class="text-white/50 text-center py-8 text-sm border border-dashed border-white/10 rounded-xl">No hay palabras vetadas registradas en el sistema.</p>
        @endforelse
    </div>
    ...
    <div class="mt-8 flex justify-end gap-3 flex-wrap">
        ...
        <a href="#" data-url="/admin/banned-words/create" data-load="modal" data-title="Añadir Palabra Vetada" class="btn-modal btn-primary px-6 py-2 rounded-xl font-semibold transition-all duration-200">
            Añadir Palabra
        </a>
    </div>
</div>
