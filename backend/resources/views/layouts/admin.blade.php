            ...
            <div class="relative p-4 w-full max-w-4xl max-h-full">
                ...
                <div class="relative bg-[#0f1922] rounded-2xl shadow-2xl border border-cyan-900/40">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b border-cyan-900/40 rounded-t">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-white/10 hover:text-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-colors cursor-pointer" data-modal-hide="default-modal">
