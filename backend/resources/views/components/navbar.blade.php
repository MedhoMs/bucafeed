<nav class="w-[300px] flex flex-col pl-5 pr-5 min-h-screen z-[1] bg-[linear-gradient(180deg,#1f5252_0%,#0f2828_100%)] shadow-[5px_0px_20px_rgba(0,0,0,0.6)]" id="principalNav">
...
<x-navbar-link title="Inicio" to="/admin/home" >
...
<x-navbar-link title="Usuarios" to="/admin/users">
...
<x-navbar-link title="Centros educativos" to="/admin/schools">
...
<x-navbar-link title="Eventos" to="/admin/events">
...
<x-navbar-link title="Preguntas / Foro" to="/admin/questions">
...
<x-navbar-link title="Reputación y logros" to="/admin/badges">
...
<x-navbar-link title="Chats" to="/admin/group-chats">
...
@endif
    ...
    <div class="mt-auto relative">
        <a href="/profile" class="relative flex items-center gap-2.5 mb-5 mr-4 rounded-xl text-[17px] font-medium py-3 px-4 text-white no-underline transition-all duration-200 ease-in-out hover:bg-[#406071] hover:cursor-pointer active:bg-[#406071] active:font-bold">
            @if(app()->environment('local'))
            ...
            @endif
            Perfil
            <svg id="dots" onclick="toggleDotsPopup(event)" class="absolute right-4 w-6 h-6 z-10 rounded-xl hover:bg-[#447c9a] transition-colors duration-200 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 19m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /></svg>
        </a>

        <!-- Popup -->
        <div id="popupMenu" class="hidden absolute right-10 bottom-24 bg-[#1d2b38] rounded-xl shadow-lg transition-all duration-200 ease-out opacity-0 translate-y-[5px]" style="z-index: 50;">
            <a href="/" class="flex gap-2.5 m-1 text-[17px] items-center py-3 px-4 rounded-xl text-white no-underline transition-all duration-200 ease-in-out font-medium hover:bg-[#406071] active:font-semibold">
            ...
            <a href="/login" class="flex gap-2.5 m-1 text-[17px] items-center py-3 px-4 rounded-xl text-white no-underline transition-all duration-200 ease-in-out font-medium hover:bg-[#ef4444] active:font-semibold">
