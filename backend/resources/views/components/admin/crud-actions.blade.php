...
<div class="flex items-center justify-start gap-2">
    {{ $slot }}
    <x-admin.action-btn :url="$showUrl" :title="$showTitle" color="blue">
    ...
    <x-admin.action-btn :url="$editUrl" :title="$editTitle" color="cyan">
    ...
    <x-admin.action-btn :url="$deleteUrl" :title="$deleteTitle" color="red">
