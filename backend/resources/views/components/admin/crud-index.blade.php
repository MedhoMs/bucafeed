...
<div class="p-4 sm:p-8 min-h-screen w-full min-w-0 text-white bg-linear-to-b from-(--admin-bg-gradient-start) via-(--admin-bg-gradient-via) to-(--admin-bg-main)">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-5">
        ...
        @if($createUrl)
        <button 
            class="btn-modal px-6 py-3 rounded-2xl font-bold flex items-center gap-2.5 w-full md:w-auto justify-center shadow-lg shadow-[rgba(79,209,197,0.4)] border border-white/10 hover:shadow-[rgba(79,209,197,0.4)] hover:opacity-80 cursor-pointer transition-all duration-200 active:scale-95"
